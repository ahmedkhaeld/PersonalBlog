<?php include "includes/header.php"?>
 <!-- this page to display the comments of each post -->
    <div id="wrapper">
            ...
            <?php      
                ...
                while ($row = mysqli_fetch_assoc($select_comments)) {
                    ...
                    echo "<tr>";
                        ...
                        // to reload the same page after delete the comment
                        echo "<td> <a href='post_comments.php?delete=$comment_id&comment_id=".$_GET['comment_id']."'> DELETE</a></td>";
                        echo"</tr>";
...
<?php
    ...
    if (isset($_GET['delete'])) {
        ...
        // to reload the same page after delete the comment
        header("Location: post_comments.php?comment_id=". $_GET['comment_id']."");
    }
