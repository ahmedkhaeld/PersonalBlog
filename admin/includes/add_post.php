<?php
  ...
  if (isset($_POST['create_post'])) {
      ...
      // added post creation notice  after post is created and if user want to view this post   
  ...
  ?> 
   ...
   <div class="form-group">
     ...
     <div class="form-group">
        ...
        <textarea class="form-control "name="post_content" id="body" cols="30" rows="15">
        </textarea>
     </div>
