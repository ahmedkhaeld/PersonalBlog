...
?> 
            ...
            <div class="row">
                    ...
                    function drawChart() {
                        ...
                        ['Data', 'Count'],
                        <?php    
                        $element_text=['All post', 'Published', 'Draft Post','Unapproved comments',
                        'Subscribers','Comments', 'Users', 'Categories'];
                        $element_count=[$posts_count,  $posts_published_count,$posts_draft_count,$comments_unapproved_count,
